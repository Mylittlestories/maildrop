...
<p align="center"><strong>v1.3.4</strong> · big files by email link</p>

<p align="center">
  <a href="https://mylittlestories.github.io/maildrop/">Open the live app</a>
  ·
  <a href="https://github.com/Mylittlestories/maildrop/releases/tag/v1.3.4">Latest release</a>
</p>
...
* `tests/browser.test.js` — the actual page, all twelve scripts, in jsdom, clicked
